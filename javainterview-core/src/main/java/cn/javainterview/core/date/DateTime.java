...
import cn.javainterview.core.date.format.DateParser;
import cn.javainterview.core.date.format.DatePrinter;
import cn.javainterview.core.date.format.FastDateFormat;
import cn.javainterview.core.date.format.GlobalCustomFormat;
...
import cn.javainterview.core.util.SystemPropsUtil;
...
public class DateTime extends Date {
	...
	public DateTime(CharSequence dateStr, DateParser dateParser) {
		this(dateStr, dateParser, SystemPropsUtil.getBoolean(SystemPropsUtil.JavaInterview_DATE_LENIENT, true));
	}
	...
	/**
	 * 设置一周的第一天<br>
	 * JDK的Calendar中默认一周的第一天是周日，JavaInterview中将此默认值设置为周一<br>
