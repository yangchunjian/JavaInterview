...
import cn.javainterview.core.convert.impl.*;
import cn.javainterview.core.date.DateTime;
import cn.javainterview.core.lang.Opt;
import cn.javainterview.core.lang.Pair;
import cn.javainterview.core.lang.TypeReference;
 ...
 * </p>
 * <p>
 * 在此类中，存放着默认转换器和自定义转换器，默认转换器是JavaInterview中预定义的一些转换器，自定义转换器存放用户自定的转换器。
 * </p>
 *
