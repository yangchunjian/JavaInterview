...
import cn.javainterview.core.convert.impl.DateConverter;
import cn.javainterview.core.convert.impl.TemporalAccessorConverter;
...
public class NumberWithFormat extends Number implements TypeConverter{
	...
	public Object convert(Type targetType, Object value) {
		...
		if (null != this.format && targetType instanceof Class) {
			...
			// https://gitee.com/dromara/javainterview/issues/I6IS5B
