...
import cn.javainterview.core.io.file.FileReader;
import cn.javainterview.core.io.file.*;
import cn.javainterview.core.io.file.FileWriter;
import cn.javainterview.core.io.file.FileReader.ReaderHandler;
import cn.javainterview.core.io.resource.ResourceUtil;
import cn.javainterview.core.io.unit.DataSizeUtil;
import cn.javainterview.core.lang.Assert;
import cn.javainterview.core.thread.ThreadUtil;
import cn.javainterview.core.util.*;
...
public class FileUtil extends PathUtil {
	...
	public static List<String> listFileNames(String path) throws IORuntimeException {
		...
		try {
			...
			// 防止出现jar!/cn/javainterview/这类路径导致文件找不到
 ...
 * @author JavaInterview
	...
	public static File createTempFile(File dir) throws IORuntimeException {
		return createTempFile("javainterview", null, dir, true);
	}
	...
	public static File createTempFile() throws IORuntimeException {
		return createTempFile("javainterview", null, null, true);
	}
	...
	public static File createTempFile(String suffix, boolean isReCreat) throws IORuntimeException {
		return createTempFile("javainterview", suffix, null, isReCreat);
	}
	...
	public static File createTempFile(File dir, boolean isReCreat) throws IORuntimeException {
		return createTempFile("javainterview", null, dir, isReCreat);
	}
	...
	public static File createTempFile(String prefix, String suffix, File dir, boolean isReCreat) throws IORuntimeException {
		...
		while (true) {
			try {
				// https://github.com/dromara/javainterview/issues/3103
