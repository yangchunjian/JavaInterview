...
import cn.javainterview.core.bean.NullWrapperBean;
import cn.javainterview.core.convert.BasicType;
...
import cn.javainterview.core.io.resource.ResourceUtil;
import cn.javainterview.core.lang.Assert;
import cn.javainterview.core.lang.ClassScanner;
import cn.javainterview.core.lang.Filter;
import cn.javainterview.core.lang.Singleton;
...
public class ClassUtil {
	 ...
	 *
	 * <pre>
	 * isSimple为false: "com.xiaoleilu.javainterview.util.ClassUtil"
	...
	/**
	 * 获取完整类名的短格式如：<br>
	 * cn.javainterview.core.util.StrUtil -》c.h.c.u.StrUtil
	 *
	 * @param className 类名
	 * @return 短格式类名
	 * @since 4.1.9
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，类名与方法名用{@code .}或{@code #}连接 例如：com.xiaoleilu.javainterview.StrUtil.isEmpty 或 com.xiaoleilu.javainterview.StrUtil#isEmpty
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.xiaoleilu.javainterview.StrUtil#isEmpty或com.xiaoleilu.javainterview.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.xiaoleilu.javainterview.util.ClassUtil =》 com.xiaoleilu.javainterview.util
	 *
	 * @param clazz 类
	 * @return 包名
	 */
