...
import cn.javainterview.core.collection.ListUtil;
import cn.javainterview.core.convert.Convert;
import cn.javainterview.core.lang.Editor;
import cn.javainterview.core.map.CaseInsensitiveMap;
...
public class BeanUtil {
	 ...
	 * 如果isSimple为{@code true}，则只匹配类名而忽略包名，例如：cn.javainterview.TestEntity只匹配TestEntity<br>
	 * 如果isSimple为{@code false}，则匹配包括包名的全类名，例如：cn.javainterview.TestEntity匹配cn.javainterview.TestEntity
	 *
	 * @param bean          Bean
