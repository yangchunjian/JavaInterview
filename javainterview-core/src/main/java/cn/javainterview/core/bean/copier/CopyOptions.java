package cn.javainterview.core.bean.copier;

import cn.javainterview.core.collection.CollUtil;
import cn.javainterview.core.convert.Convert;
import cn.javainterview.core.convert.TypeConverter;
import cn.javainterview.core.lang.Editor;
import cn.javainterview.core.lang.func.Func1;
import cn.javainterview.core.lang.func.LambdaUtil;
import cn.javainterview.core.util.ArrayUtil;
...
public class CopyOptions implements Serializable {
	...
	protected TypeConverter converter = (type, value) -> {
		...
		if(ArrayUtil.contains(new String[]{"cn.javainterview.json.JSONObject", "cn.javainterview.json.JSONArray"}, name)){
