...
import cn.javainterview.core.map.SafeConcurrentHashMap;
 ...
 * <li>{@code {javainterview:[a-z]+}} 匹配以"javainterview"命名的正则 {@code [a-z]+}</li>
 * </ul>
 *
 * <p>例子: </p>
 * <ul>
 ...
 * <li>{@code cn/javainterview/&#42;&#42;/*.jsp} &mdash; 匹配{@code cn/javainterview}路径下全部{@code .jsp} 文件</li>
 * <li>{@code org/&#42;&#42;/servlet/bla.jsp} &mdash; 匹配{@code cn/javainterview/servlet/bla.jsp} 或{@code cn/javainterview/testing/servlet/bla.jsp} 或 {@code org/servlet/bla.jsp}</li>
