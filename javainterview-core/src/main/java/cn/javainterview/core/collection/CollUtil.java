package cn.javainterview.core.collection;

import cn.javainterview.core.bean.BeanUtil;
import cn.javainterview.core.comparator.CompareUtil;
import cn.javainterview.core.comparator.PinyinComparator;
import cn.javainterview.core.comparator.PropertyComparator;
	...
	public static <T> Collection<T> addAll(Collection<T> collection, Object value, Type elementType) {
		...
		if (value instanceof Iterator) {
			...
			if(value instanceof Map && BeanUtil.isBean(TypeUtil.getClass(elementType))){
				//https://github.com/dromara/javainterview/issues/3139
