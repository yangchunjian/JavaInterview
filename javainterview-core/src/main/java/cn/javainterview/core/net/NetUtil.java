...
import cn.javainterview.core.collection.EnumerationIter;
...
import cn.javainterview.core.util.JNDIUtil;
import cn.javainterview.core.util.RandomUtil;
...
public class NetUtil {
	 ...
	 * 此方法不会抛出异常，获取失败将返回{@code null}<br>
	 * <p>
	 * 见：https://github.com/dromara/javainterview/issues/428
	 *
	 * @return 本机网卡IP地址，获取失败返回{@code null}
	 * @since 3.0.1
	 */
	 ...
	 *
	 * <pre class="code">
	 *     NetUtil.attrNames("javainterview.cn", "TXT")
	 * </pre>
	 *
	 * @param hostName  主机域名
	 * @param attrNames 属性
