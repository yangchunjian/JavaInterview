...
import cn.javainterview.core.bean.BeanPath;
...
import cn.javainterview.core.getter.BasicTypeGetter;
...
public class Dict extends LinkedHashMap<String, Object> implements BasicTypeGetter<String> {
	 ...
	 * <pre>
	 *     User user = GenericBuilder.of(User::new).with(User::setUsername, "javainterview").build();
