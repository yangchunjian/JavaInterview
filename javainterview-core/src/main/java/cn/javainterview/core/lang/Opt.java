...
import cn.javainterview.core.collection.CollectionUtil;
import cn.javainterview.core.lang.func.Func0;
import cn.javainterview.core.lang.func.VoidFunc0;
 ...
 * 详细见：<a href="https://gitee.com/dromara/javainterview/pulls/426">https://gitee.com/dromara/javainterview/pulls/426</a>
 *
 * @param <T> 包裹里元素的类型
...
public class Opt<T> {
	 ...
	 * <p> 例如如果值存在就打印结果
	 * <pre>{@code
	 * Opt.ofNullable("Hello javainterview!").ifPresent(Console::log);
	 * }</pre>
	 *
	 ...
	 * <pre>{@code
	 * Opt.ofNullable("Hello javainterview!").ifPresentOrElse(Console::log, () -> Console.error("Ops!Something is wrong!"));
	 * }</pre>
	 *
	 ...
	 * <pre>{@code
	 * String javainterview = Opt.ofBlankAble("javainterview").mapOrElse(String::toUpperCase, () -> Console.log("yes")).mapOrElse(String::intern, () -> Console.log("Value is not present~")).get();
	 * }</pre>
	 *
	 * @param <U>         map后新的类型
